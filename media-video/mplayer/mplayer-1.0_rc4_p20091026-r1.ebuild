...
+theora +toolame +tremor +truetype +twolame +unicode v4l v4l2 vaapi vdpau vidix
+vorbis win32codecs +X +x264 xanim xinerama +xscreensaver +xv +xvid xvmc zoran"
# nemesi
...
src_prepare() {
	...
	if use vaapi; then
		...
		epatch "${FILESDIR}"/${PN}-vaapi-fix.patch
	fi
}
