...
SRC_URI="mirror://sourceforge/freepascal/fpcbuild-${PV}.tar.gz
	amd64? ( mirror://sourceforge/freepascal/fpc-2.4.4.x86_64-linux.tar )
	ppc? ( mirror://sourceforge/freepascal/fpc-2.4.4.powerpc-linux.tar )
	sparc? ( mirror://sourceforge/freepascal/fpc-2.2.4.sparc-linux.tar )
	x86? ( mirror://sourceforge/freepascal/fpc-2.4.4.i386-linux.tar )
